...
# ✅ Configure Gemini API using .env file
...
def page_home():
    ...
    with col1:
        st.image("https://cdn1.iconfinder.com/data/icons/business-dual-color-glyph-set-3/128/Data_warehouse-1024.png", width=500)
